...
while (isset($setupVars['PIHOLE_DNS_'.$i])) {
    ...
    } elseif (!isset($custom1)) {
        // First non-server list DNS address goes into custom1
        $custom1 = $setupVars['PIHOLE_DNS_'.$i];
    } elseif (!isset($custom2)) {
        // Second non-server list DNS address goes into custom2
        $custom2 = $setupVars['PIHOLE_DNS_'.$i];
    } elseif (!isset($custom3)) {
        // Third non-server list DNS address goes into custom3
        $custom3 = $setupVars['PIHOLE_DNS_'.$i];
    } elseif (!isset($custom4)) {
        // Fourth non-server list DNS address goes into custom4
        $custom4 = $setupVars['PIHOLE_DNS_'.$i];
    } elseif (!isset($custom5)) {
        // Fifth non-server list DNS address goes into custom5
        $custom5 = $setupVars['PIHOLE_DNS_'.$i];
    } elseif (!isset($custom6)) {
        // Sixth non-server list DNS address goes into custom6
        $custom6 = $setupVars['PIHOLE_DNS_'.$i];
    } elseif (!isset($custom7)) {
        // Sixth non-server list DNS address goes into custom6
        $custom7 = $setupVars['PIHOLE_DNS_'.$i];
    } elseif (!isset($custom8)) {
        // Sixth non-server list DNS address goes into custom6
        $custom8 = $setupVars['PIHOLE_DNS_'.$i];
    }
    ++$i;
}
                            ...
                            <div class="col-lg-6">
                                <div class="box box-warning">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <strong>Custom 3 (IPv4)</strong>
                                                <div class="row">
                                                    <div class="col-md-1"><div>
                                                        <input type="checkbox" name="custom3" id="custom3" value="Customv4" <?php if (isset($custom3)) { ?>checked<?php } ?>>
                                            ...
                                            <div class="col-md-6">
                                                <strong>Custom 4 (IPv4)</strong>
                                                <div class="row">
                                                    <div class="col-md-1"><div>
                                                        <input type="checkbox" name="custom4" id="custom4" value="Customv4" <?php if (isset($custom4)) { ?>checked<?php } ?>>
                                            ...
                                            <div class="col-md-6">
                                                <strong>Custom 5 (IPv4)</strong>
                                                <div class="row">
                                                    <div class="col-md-1"><div>
                                                        <input type="checkbox" name="custom5" id="custom5" value="Customv4" <?php if (isset($custom5)) { ?>checked<?php } ?>>
                                                        <label for="custom5"></label></div>
                                                    </div>
                                                    <div class="col-md-11">
                                                        <input type="text" name="custom5val" class="form-control" autocomplete="off" spellcheck="false" autocapitalize="none" autocorrect="off"
                                                            <?php if (isset($custom5)) { ?>value="<?php echo $custom5; ?>"<?php } ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <strong>Custom 6 (IPv4)</strong>
                                                <div class="row">
                                                    <div class="col-md-1"><div>
                                                        <input type="checkbox" name="custom6" id="custom6" value="Customv4" <?php if (isset($custom6)) { ?>checked<?php } ?>>
                                                        <label for="custom6"></label></div>
                                                    </div>
                                                    <div class="col-md-11">
                                                        <input type="text" name="custom6val" class="form-control" autocomplete="off" spellcheck="false" autocapitalize="none" autocorrect="off"
                                                            <?php if (isset($custom6)) { ?>value="<?php echo $custom6; ?>"<?php } ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <strong>Custom 7 (IPv4)</strong>
                                                <div class="row">
                                                    <div class="col-md-1"><div>
                                                        <input type="checkbox" name="custom7" id="custom7" value="Customv4" <?php if (isset($custom7)) { ?>checked<?php } ?>>
                                                        <label for="custom7"></label></div>
                                                    </div>
                                                    <div class="col-md-11">
                                                        <input type="text" name="custom7val" class="form-control" autocomplete="off" spellcheck="false" autocapitalize="none" autocorrect="off"
                                                            <?php if (isset($custom7)) { ?>value="<?php echo $custom7; ?>"<?php } ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <strong>Custom 8 (IPv4)</strong>
                                                <div class="row">
                                                    <div class="col-md-1"><div>
                                                        <input type="checkbox" name="custom8" id="custom8" value="Customv4" <?php if (isset($custom8)) { ?>checked<?php } ?>>
                                                        <label for="custom8"></label></div>
                                                    </div>
                                                    <div class="col-md-11">
                                                        <input type="text" name="custom8val" class="form-control" autocomplete="off" spellcheck="false" autocapitalize="none" autocorrect="off"
                                                            <?php if (isset($custom8)) { ?>value="<?php echo $custom8; ?>"<?php } ?>>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
